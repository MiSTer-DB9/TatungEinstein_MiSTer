...
UPSTREAM_REPO="https://github.com/MiSTer-devel/TatungEinstein_MiSTer.git"
CORE_NAME=(TatungEinstein)
...
UPSTREAM_CORE_NAME=(TatungEinstein)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(TatungEinstein.qpf)
COMPILATION_OUTPUT=(output_files/TatungEinstein.rbf)
